...
<html lang="en" class="js csstransforms3d">
   <head>
      ...
      <link rel="stylesheet" href="styles/themes/tooltipster-punk.css">
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter35733995 = new Ya.Metrika({
                    id:35733995,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/35733995" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
   <div id="particles-js">
      <div id="viewport">
         <div id="cube">
            <div id="front">
               ...
               <!--<p>HTML/CSS/JavaScript<br>UI/UX</p>-->
               <a href="https://vk.com/err0r" class="link tooltip" title="Социальная сеть Вконтакте"><i class="fa fa-vk fa-2x"></i></a>
               <a href="https://www.facebook.com/alexangeras" class="link tooltip" title="Социальная сеть Facebook"><i class="fa fa-facebook-square fa-2x"></i></a>
               <a href="skype:imerr0r" class="link tooltip" title="Skype"><i class="fa fa-skype fa-2x"></i></a>
               <a href="https://telegram.me/geralex/" class="link tooltip" title="Мессенджер Telegram"><i class="fa fa-paper-plane fa-2x"></i></a>
            </div>
            <div id="right">
               ...
               <div class="icon-container" id="ui-ux">
                  <svg version="1.1" class="tooltip" title="Спроектировать интерфейс для Вашего WEB-приложения, заранее проанализировав и оценив, что именно будет важнее всего вашему будущему пользователю. Переделать существующий дизайн страниц или создать новый с учетом последних тенденций в мире WEB-дизайна и технологий. (UI/UX, WEB-Design)" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     ...
                     <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="171.2178" y1="180.4805" x2="171.2178" y2="180.4805">
                     ...
                     <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="96.8076" y1="60.2554" x2="94.9738" y2="58.7359">
                        <stop  offset="0" style="stop-color:#FFFFFF"/>
                        <stop  offset="0.0718" style="stop-color:#DFDFDF"/>
                        <stop  offset="0.2156" style="stop-color:#A5A5A5"/>
                        <stop  offset="0.3593" style="stop-color:#727272"/>
               ...
               <div class="icon-container" id="cms">
                  <svg version="1.1" class="tooltip" title="Разработать Вам сайт с использованием уже готовых решений в области хранения информации (CMS), будь это личный блог, магазин или сайт новостей, личное портфолио или просто сайт-визитка с несколькими страницами. Так же подключить и настроить систему управления взаимоотношений с клиентами (CRM) для оптимизации управления бизнес процессами." id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     width="160px" height="160px" viewBox="0 0 160 160" enable-background="new 0 0 160 160" xml:space="preserve">
